module.exports = async function groupCommand(sock, msg, command, args) {
  ...
  if (!isBotAdmin) {
    return sock.sendMessage(from, { text: '❌ Bot bukan admin!\npromote bot terlebih dahulu' }, { quoted: msg })
  }

  if (!isSenderAdmin) {
    return sock.sendMessage(from, { text: '❌ maaf Kamu bukan admin!' }, { quoted: msg })
  }
